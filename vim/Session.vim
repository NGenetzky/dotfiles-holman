...
map Y y$
nnoremap \cc :set cursorcolumn!
nnoremap \cl :set cursorline!
let s:cpo_save=&cpo
set cpo&vim
...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/bundle/syntastic,/usr/share/vim/vimfiles,/usr/share/vim/vim72,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set showcmd
set smartcase
set softtabstop=4
...
silent! normal! zE
let s:l = 62 - ((7 * winheight(0) + 13) / 27)
